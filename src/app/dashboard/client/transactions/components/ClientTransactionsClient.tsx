  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-start">
        <Link href="/dashboard/client">
          <Button
            size="sm"
            variant="outline"
            className="bg-content2 hover:bg-default-200 text-default-700 font-semibold rounded-xl text-xs flex items-center gap-2 h-9 px-4"
          >
      ...
      <div className="p-6 bg-content1 rounded-2xl border border-border shadow-sm space-y-4">
                      ...
                      >
                        <Table.Cell>
                          <div className="flex items-center gap-2.5">
                            <Avatar className="w-7 h-7 rounded-full text-[10px] font-bold bg-blue-50 text-brand-500">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-border overflow-hidden">
